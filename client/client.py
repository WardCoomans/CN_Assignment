...
def send_request(command, ADDR, resource):      # Main function communicating with the host
    ...
    if command == 'GET':
        ...
        for elem in external_images:    # Grab the external images using a seperate socket object in the same fashion as the internal images
